...
const generalLogger = logService.setLogger('general')
...
import DenmarkBondsRouter from './routes/api/denmarkonds'
import BelarusRouter from './routes/api/belarus'
...
app.use('/api/denmark', DenmarkBondsRouter)
app.use('/api/belarus', BelarusRouter)
