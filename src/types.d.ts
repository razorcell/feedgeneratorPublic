...
type EuronextETFSourceConfig = sourceConfig & {
  EtfListSize?: number
  issuerDescriptionLanuchDateTargetTDs: {
    id: number
    name: keyof LabelValueRow
  }[]
}

type DenmarkBondsourceConfig = sourceConfig & {
  get_bonds_details_chunck_size: number
  get_bonds_list_size: number
  page_limit: number
}

type BelarusSourceConfig = sourceConfig 
